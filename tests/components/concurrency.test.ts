...
test("destroying/recreating a subwidget with different props (if start is not over)", async () => {
  ...
  class Child extends Component {
    static template = xml`<span>child:<t t-esc="this.props.val"/></span>`;
    props = props();
    setup() {
      useLogLifecycle();
      n++;
...
test("creating two async components, scenario 2", async () => {
  ...
  class ChildA extends Component {
    static template = xml`<span>a<t t-esc="this.props.val"/></span>`;
    props = props();
    setup() {
      useLogLifecycle();
  ...
  class ChildB extends Component {
    static template = xml`<span>b<t t-esc="this.props.val"/></span>`;
    props = props();
    setup() {
      useLogLifecycle();
      onWillStart(() => defB);
...
test("concurrent renderings scenario 2", async () => {
  ...
  let stateB: any = null;
  class ComponentC extends Component {
    static template = xml`<span><t t-esc="this.props.fromA"/><t t-esc="this.props.fromB"/></span>`;
    props = props();
...
test("concurrent renderings scenario 9", async () => {
  ...
  class ComponentD extends Component {
    static template = xml`<span><t t-esc="this.props.fromA"/><t t-esc="this.props.fromC"/></span>`;
    props = props();
    setup() {
      useLogLifecycle();
    }
  ...
  class ComponentB extends Component {
    static template = xml`<b><t t-esc="this.props.fromA"/></b>`;
    props = props();
...
test("concurrent renderings scenario 11", async () => {
  ...
  let child: any = null;
  class Child extends Component {
    static template = xml`<span><t t-esc="this.props.val"/>|<t t-esc="this.val"/></span>`;
    props = props();
    val = 3;
...
test("two renderings initiated between willPatch and patched", async () => {
  ...
  class Panel extends Component {
    static template = xml`<abc><t t-esc="this.props.val"/><t t-esc="this.mounted" /></abc>`;
    props = props();
    mounted: any;
    setup() {
      useLogLifecycle();
...
test("t-key on dom node having a component", async () => {
  let def: any;
  class Child extends Component {
    static template = xml`<t t-esc="this.props.key" />`;
    props = props();
    setup() {
      onWillStart(() => def);
...
test("t-key on dynamic async component (toggler is never patched)", async () => {
  let def: any;
  class Child extends Component {
    static template = xml`<div t-esc="this.props.key" />`;
    props = props();
    setup() {
      onWillStart(() => def);
      useLogLifecycle(this.props.key);
...
test("Cascading renders after microtaskTick", async () => {
  ...
  class Element extends Component {
    static template = xml`<t t-esc="this.props.id" />`;
    props = props();
  }
...
test("delayed rendering, but then initial rendering is cancelled by yet another render", async () => {
  ...
  class D extends Component {
    static template = xml`<button t-on-click="this.increment"><t t-esc="this.state.val"/></button>`;
    state = proxy({ val: 1 });
    setup() {
      useLogLifecycle();
    }
  ...
  class C extends Component {
    static template = xml`<D/><p><t t-esc="this.props.value"/></p>`;
    static components = { D };
    props = props();
    setup() {
      useLogLifecycle();
...
test("delayed rendering, reusing fiber and stuff", async () => {
  ...
  class B extends Component {
    static template = xml`<t t-esc="this.props.value"/><C /><t t-set="noop" t-value="this.notify()"/>`;
    static components = { C };
    props = props();
    notify: any;
...
test("delayed rendering, then component is destroyed and  stuff", async () => {
  ...
  class B extends Component {
    static template = xml`<t t-esc="this.props.value"/><t t-if="this.props.value lt 10"><C /></t>`;
    static components = { C };
    props = props();
    setup() {
      useLogLifecycle();
...
test("delayed rendering, reusing fiber then component is destroyed and  stuff", async () => {
  ...
  class B extends Component {
    static template = xml`<t t-esc="this.props.value"/><C />`;
    static components = { C };
    props = props();
    setup() {
      useLogLifecycle();
...
test("destroyed component causes other soon to be destroyed component to rerender, weird stuff happens", async () => {
  ...
  class B extends Component {
    static template = xml`<t t-set="noop" t-value="this.notify()"/><t t-esc="this.props.value"/>`;
    props = props();
    setup() {
      useLogLifecycle();
      onWillDestroy(() => {
...
test("delayed rendering, destruction, stuff happens", async () => {
  ...
  class D extends Component {
    static template = xml`D<button t-on-click="this.increment"><t t-esc="this.state.val"/></button>`;
    state = proxy({ val: 1 });
    setup() {
      useLogLifecycle();
    }
  ...
  class C extends Component {
    static template = xml`C<D/><p><t t-esc="this.props.value"/></p>`;
    static components = { D };
    props = props();
    setup() {
      useLogLifecycle();
...
test.skip("delayed render is not cancelled by upcoming render", async () => {
  ...
  class B extends Component {
    static template = xml`
        <t t-esc="this.props.state.groups.length"/>
        <t t-esc="this.props.state.config.test"/>`;
