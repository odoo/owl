...
export const store = reactive({
  ...
  toggleOrSelectPrevElement(toggle){
    ...
    const currentElement = document.getElementById("treeElement/" + this.activeComponent.path.join("/"));
  ...
  loadGetterContent(inputObj){
    ...
    evalInWindow("loadGetterContent", [JSON.stringify(this.activeComponent.path), JSON.stringify(obj)])
    .then(result => {
