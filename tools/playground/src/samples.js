...
const EXAMPLES_V3 = [
  { id: "hello_world", category: "Examples", description: "Hello World", files: {} },
  {
    ...
    files: { "main.js": "sub_component/main.js" },
  },
  {
    id: "props",
    category: "Examples",
    description: "Props and validation",
    files: {
      "main.js": "props/main.js",
      "main.css": "props/main.css",
      "product_card.js": "props/product_card.js",
      "product_card.xml": "props/product_card.xml",
    },
  },
  {
    id: "list_reactivity",
    category: "Examples",
    description: "Reactive list (proxy + computed)",
    files: { "main.js": "list_reactivity/main.js" },
  },
  {
    id: "form_binding",
    category: "Examples",
    description: "Form binding (t-model)",
    files: {
      "main.js": "form_binding/main.js",
      "main.xml": "form_binding/main.xml",
    },
  },
  {
    id: "dom_ref",
    category: "Examples",
    description: "DOM access (t-ref)",
    files: { "main.js": "dom_ref/main.js" },
  },
  {
    id: "slots",
    category: "Examples",
    description: "Slots (default + named)",
    files: {
  ...
  },
  {
    id: "plugins",
    category: "Examples",
    description: "Plugins (shared state)",
    files: { "main.js": "plugins/main.js" },
  },
  {
    id: "async_suspense",
    category: "Examples",
    description: "Async + Suspense",
    files: { "main.js": "async_suspense/main.js" },
  },
  // NOTE: the "kanban_board" and "web_client" demos are not ready yet, so they
  // are temporarily hidden from the playground selector. The sample code still
  // lives under samples/ — re-enable these entries once the demos are polished.
  // {
  //   id: "kanban_board",
  //   category: "Demos",
